...
yaml  # Example: Run tests on every push
  name: Test
...
yaml  # Verify Docker containers build successfully
  name: Docker Build
  on: [push]
  jobs:
    build:
...
Review: What did we accomplish last week? (10 min)
Planning: What are we doing this week? (20 min)
Blockers: Any issues or help needed? (10 min)
Assign tasks: Who does what by when? (10 min)
Record meeting notes (5 min)
...
Commit early, commit often - Don't wait until the last day
Test your code - Make sure it actually works before pushing
Communicate proactively - If stuck, ask for help immediately
Start simple, add complexity - Get basic version working first
Document as you go - Don't leave documentation until the end
Use the lab sessions - Get help from lecturers when available
Backup everything - Push to GitHub regularly
